// Código para os sensores de obstáculos
...
// --- Defines ------
#define sens_obs_1 GPIO_NUM_32 // sensor dianteiro
#define sens_obs_2 GPIO_NUM_33 // sensor traseiro
// ------------------
...
void setup() {
  ...
  // Utilizo a mesma prioridade para ambas as interrupções 
  // -----------------------------------------------
